  ...
  const userInfo = user.map((user) => {
    return (
      <>
        ...
        <Box style={{ margin: 20 }}>
          <Card style={cardStyle} className="profile-card">
            <CardHeader title="About Me"></CardHeader>
            <CardContent className='profile-me'>
              I am a Full-Stack Developer passionate about creating eye catching
              front end websites and seemless backend architecture. My focus is
              on front-end developing to create interactive webpages for the end
              user. I have been working as a freelance developer to help my
              clients update and maintain their websites to increase users
              experiences. While also trying to improve the clients aquisitions
              on the business side. Look forward to hearing from you!
            </CardContent>
          </Card>
          <div>
            <Button
              ...
              style={{ marginTop: 10, color: "whitesmoke" }}
            >
              Resume
            </Button>
            <IconButton
            ...
            >
              <GitHubIcon sx={{ fontSize: 40, color: "whitesmoke" }} />
            </IconButton>
            <IconButton
              href={user.linkedin}
              target="_blank"
              rel="noopener noreferrer"
            >
              <LinkedInIcon sx={{ fontSize: 40, color: "whitesmoke" }} />
            </IconButton>
          </div>
        </Box>
      </>
    ...
    <div style={{ marginTop: 100, paddingLeft: 10 }}>
      ...
      <Box>
        ...
        <TabPannel value={value} index={0}>
          <Typography style={{ color: "whitesmoke" }} variant="h4">
            Education
          </Typography>
          {userEducation}
        </TabPannel>
